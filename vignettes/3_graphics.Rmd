...
This document presents possible options how the final model can be described through plots and graphics

# Single variable results

As you actually saw in previous sections, the model tranformation can be presented on simple graphics.
