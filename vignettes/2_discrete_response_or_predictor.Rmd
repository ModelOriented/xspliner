...
Similiarily to continuous variables the first thing we do is to get black box model response on signle variable, called **effect**.
...
As in countinuous case we need to use the formula within `xspline` function:
