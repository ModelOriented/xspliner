...
- [Discrete response or predictor](https://ModelOriented.github.io/xspliner/articles/2_discrete_response_or_predictor.html) - learn how model works when black box is classificator or what effect and transition is used when predictor is dicrete variable
- [Graphics](https://ModelOriented.github.io/xspliner/articles/3_graphics.html) - learn how to plot the results, or compare compare xspliner with base black box.
- [Automation](https://ModelOriented.github.io/xspliner/articles/4_automation.html) - learn how to automate building xspliners without specifying your own formula and/or using global parameters
- [Methods](https://ModelOriented.github.io/xspliner/articles/5_methods.html) - learn about other xspliner methods and its environment
- [Extras](https://ModelOriented.github.io/xspliner/articles/6_extras.html) - what additional features are provided by xspliner
- [Use cases](https://ModelOriented.github.io/xspliner/articles/7_use_cases.html) - see `xspliner` in action with examples
