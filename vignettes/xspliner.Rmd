...
- [Discrete response or predictor](./discrete.html) - learn how model works when black box is classificator or what effect and transition is used when predictor is dicrete variable
