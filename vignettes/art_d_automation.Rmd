...
but we can provide some model based parameters upfront using DALEX2's `explainer` object (see next section).
...
Most of R based ML models satisfy the above condition. One of exceptions is XGBoost which in actual xspliner version needs to be handled in the more complex xspline call. You can see it in [use cases](https://ModelOriented.github.io/xspliner/articles/use_cases.html) 
...
# Integration with DALEX2

As mentioned in the previous section, xspliner is integrated with DALEX2 package.
